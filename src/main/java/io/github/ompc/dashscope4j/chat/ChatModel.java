...
import static io.github.ompc.dashscope4j.chat.ChatModel.Mode.MULTIMODAL;
...
public record ChatModel(Mode mode, String name, URI remote) implements Model {
     ...
     */
    public static ChatModel QWEN_TURBO = ChatModel.ofText("qwen-turbo");
     ...
     */
    public static ChatModel QWEN_PLUS = ChatModel.ofText("qwen-plus");
     ...
     * <p>模型支持8k tokens上下文，为了保证正常的使用和输出，API限定用户输入为6k tokens。</p>
     */
    public static ChatModel QWEN_MAX = ChatModel.ofText("qwen-max");
     ...
     */
    public static ChatModel QWEN_MAX_LONGCONTEXT = ChatModel.ofText("qwen-max-longcontext");
     ...
     */
    public static ChatModel QWEN_VL_PLUS = ChatModel.ofMultimodal("qwen-vl-plus");
     ...
     */
    public static ChatModel QWEN_VL_MAX = ChatModel.ofMultimodal("qwen-vl-max");
     ...
     */
    public static ChatModel QWEN_AUDIO_TURBO = ChatModel.ofMultimodal("qwen-audio-turbo");
     ...
     */
    public static ChatModel QWEN_AUDIO_CHAT = ChatModel.ofMultimodal("qwen-audio-chat");
