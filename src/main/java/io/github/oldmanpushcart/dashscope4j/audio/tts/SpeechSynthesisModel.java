...
import static io.github.oldmanpushcart.dashscope4j.audio.tts.SpeechSynthesisOptions.FORMAT;
import static io.github.oldmanpushcart.dashscope4j.audio.tts.SpeechSynthesisOptions.SAMPLE_RATE;
 ...
 * @param remote 模型地址
 * @param option 模型默认选项
 *               可以被{@link SpeechSynthesisRequest#option()}中的选项所强制替换
 * @since 2.2.0
 */
public record SpeechSynthesisModel(String name, URI remote, Option option) implements Model {
    ...
    public static final SpeechSynthesisModel COSYVOICE_LONGXIAOCHUN_V1 = new Builder()
            ...
            .options(FORMAT, SpeechSynthesisRequest.Format.MP3)
            .build();
