...
import io.github.oldmanpushcart.dashscope4j.client.aigc.audio.asr.fun_asr.FunAsrModel.In;
import io.github.oldmanpushcart.dashscope4j.client.aigc.audio.asr.fun_asr.FunAsrModel.Out;
...
public class FunAsrSession extends ParameterSession<In, Out> {

    private final FunAsrModel model;

    private FunAsrSession(Builder builder) {
        super(builder);
    ...
    public static Builder newBuilder(FunAsrSession session) {
        return new Builder(session);
    }

    public static class Builder extends ParameterSession.Builder<FunAsrSession, Builder> {

        private FunAsrModel model;

        public Builder() {

        }

        public Builder(FunAsrSession session) {
            super(session);
            this.model = session.model;
        }

        public Builder model(FunAsrModel model) {
            this.model = model;
            return this;
        }

        @Override
        public FunAsrSession build() {
            return new FunAsrSession(this);
        }
