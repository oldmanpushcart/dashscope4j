...
public class QwenTtsRealtimeSessionUpdateClientEvent extends QwenTtsRealtimeClientEvent{

    @JsonProperty("session")
    private final QwenTtsRealtimeSession session;

    public QwenTtsRealtimeSessionUpdateClientEvent(String id, QwenTtsRealtimeSession session) {
