...
import static io.github.oldmanpushcart.dashscope4j.client.internal.InternalContents.WEBSOCKET_CLOSE_REASON_MAX_LENGTH;
import static io.github.oldmanpushcart.dashscope4j.client.internal.util.StringUtils.substring;
...
class ExchangeImpl<T> implements Exchange<T> {
    ...
    private record OutFrame(

            @JsonProperty("header")
            ExchangeImpl.OutFrame.Header header,
