...
import io.github.oldmanpushcart.dashscope4j.client.aigc.audio.omni.realtime.OmniRealtimeEmitter.ManualVad;
import io.github.oldmanpushcart.dashscope4j.client.aigc.audio.omni.realtime.OmniRealtimeSession;
import io.github.oldmanpushcart.dashscope4j.client.aigc.audio.omni.realtime.event.client.*;
...
public class ManualVadHandler implements Realtime.Handler<OmniRealtimeClientEvent, OmniRealtimeServerEvent> {
    ...
    public CompletionStage<Void> onData(OmniRealtimeServerEvent output) {
        futureSlot.complete(output.type());
