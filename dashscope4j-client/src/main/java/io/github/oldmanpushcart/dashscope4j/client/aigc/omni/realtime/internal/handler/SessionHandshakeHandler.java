package io.github.oldmanpushcart.dashscope4j.client.aigc.omni.realtime.internal.handler;

import io.github.oldmanpushcart.dashscope4j.client.aigc.omni.realtime.OmniRealtimeEmitter;
import io.github.oldmanpushcart.dashscope4j.client.aigc.omni.realtime.OmniRealtimeErrorException;
import io.github.oldmanpushcart.dashscope4j.client.aigc.omni.realtime.OmniRealtimeSession;
import io.github.oldmanpushcart.dashscope4j.client.api.realtime.Realtime;
import io.github.oldmanpushcart.dashscope4j.client.aigc.omni.realtime.event.client.OmniRealtimeClientEvent;
import io.github.oldmanpushcart.dashscope4j.client.aigc.omni.realtime.event.client.OmniRealtimeSessionUpdateClientEvent;
import io.github.oldmanpushcart.dashscope4j.client.aigc.omni.realtime.event.server.OmniRealtimeErrorServerEvent;
import io.github.oldmanpushcart.dashscope4j.client.aigc.omni.realtime.event.server.OmniRealtimeServerEvent;
import io.github.oldmanpushcart.dashscope4j.client.aigc.omni.realtime.event.server.OmniRealtimeSessionCreatedServerEvent;
import io.github.oldmanpushcart.dashscope4j.client.aigc.omni.realtime.event.server.OmniRealtimeSessionUpdatedServerEvent;
