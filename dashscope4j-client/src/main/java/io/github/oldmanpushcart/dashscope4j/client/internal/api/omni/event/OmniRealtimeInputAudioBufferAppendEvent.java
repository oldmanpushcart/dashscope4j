...
public class OmniRealtimeInputAudioBufferAppendEvent extends OmniRealtimeEvent {

    @JsonProperty("audio")
    @JsonSerialize(using = ByteBufferToBase64JsonSerializer.class)
    private final ByteBuffer buffer;

    public OmniRealtimeInputAudioBufferAppendEvent(String id, ByteBuffer buffer) {
    ...
    static class ByteBufferToBase64JsonSerializer extends JsonSerializer<ByteBuffer> {
